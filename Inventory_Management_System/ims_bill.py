...
class Bill_App:
    def __init__(self,root):
        ...
        search_no_btn=Button(F2,command=self.search_item,bg="black",text="Search",fg="pink",pady=15,width=11,bd=5,font="arial 15 bold").grid(row=1,column=1,padx=5,pady=5)
        ...
        search_name_btn=Button(F3,command=self.add_item,bg="pink",text="Add",fg="Black",pady=15,width=11,bd=5,font="arial 15 bold").grid(row=4,column=1,padx=5,pady=5)
        ...
        total_btn=Button(btn_F,command=self.find_bill,bg="black",text="Total",fg="pink",pady=15,width=11,bd=5,font="arial 15 bold").grid(row=0,column=0,padx=5,pady=5)
        GBill_btn=Button(btn_F,command=self.bill_area,bg="Blue",text="Generate Bill",fg="pink",pady=15,width=15,bd=5,font="arial 15 bold").grid(row=0,column=1,padx=5,pady=5)
        Clear_btn=Button(btn_F,command=self.clear,bg="Blue",text="Clear",fg="pink",pady=15,width=11,bd=5,font="arial 15 bold").grid(row=0,column=2,padx=5,pady=5)
        Exit_btn=Button(btn_F,command=self.root.destroy,bg="Blue",text="Exit",fg="pink",pady=15,width=11,bd=5,font="arial 15 bold").grid(row=0,column=3,padx=5,pady=5)
        self.welcome_bill()
